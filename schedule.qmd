...
Most workshop meetings will feature an introduction to a new tool/method/approach and practice. Once per term, usually toward the end of the quarter, we will have an open-ended coding session in which you can work on any project that may benefit from the group setting.

The workshop is open to everyone, but those formally enrolled will receive full credit by attending to every meeting. Meeting times are TBD (unsure if there will be a pre-determined time or if we can arrange it on our own).
...
### Meeting 7: Declaring and diagnosing research designs (*guest:* Graeme Blair or Alex Coppock?)

### Meeting 8: Academic websites
