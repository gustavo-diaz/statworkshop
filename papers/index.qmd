...
- {{< fa file-code >}} [Template](https://github.com/gustavo-diaz/rworkshop/blob/main/papers/template.qmd)
- {{< fa book >}} [Sample bibliography](https://github.com/gustavo-diaz/rworkshop/blob/main/papers/references.bib)
